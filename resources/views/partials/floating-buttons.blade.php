        ...
        <div data-x-data="{
            ...
            <div data-x-bind="popupAnim"
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <span class="font-bold text-black uppercase tracking-wider mb-1">Наш Telegram</span>
                    <p class="text-xs text-gray-400 mb-5 font-medium">Приватный контент и скидки.</p>

                    <a data-x-bind="subscribeBtn"
                        class="bg-[#cd1d46] hover:bg-[#b71833] text-black hover:!text-black font-bold text-xs uppercase tracking-widest py-3 px-6 rounded shadow-lg shadow-[#cd1d46]/20 w-full block transition-transform active:scale-95 cursor-pointer">
                        Подписаться
                    </a>
                </div>
            </div>
        ...
        <div class="flex flex-row md:flex-col gap-4">
            ...
            @if(isset($contacts['whatsapp']) && $contacts['whatsapp'])
                <a href="https://wa.me/{{ $contacts['whatsapp'] }}" target="_blank"
                   class="w-12 h-12 bg-[#25D366] hover:bg-[#128C7E] text-black shadow-lg shadow-[#25D366]/30 flex items-center justify-center transition-transform hover:scale-105 active:scale-95"
                   aria-label="WhatsApp">
            ...
            @if(isset($contacts['telegram']) && $contacts['telegram'])
                <a href="https://t.me/{{ $contacts['telegram'] }}" target="_blank"
                   class="w-12 h-12 bg-[#0088cc] hover:bg-[#006699] text-black shadow-lg shadow-[#0088cc]/30 flex items-center justify-center transition-transform hover:scale-105 active:scale-95"
                   aria-label="Telegram">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
