...
--}}
<div class="fixed bottom-8 z-40 flex flex-row gap-4 items-end pointer-events-none font-serif
        ...
        <div data-x-data="{
            ...
            <div data-x-bind="popupAnim"
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <span class="font-bold text-white uppercase tracking-wider mb-1">Наш Telegram</span>
                    <p class="text-xs text-gray-400 mb-5 font-medium">Приватный контент и скидки.</p>

                    <a data-x-bind="subscribeBtn"
                        class="bg-[#cd1d46] hover:bg-[#b71833] text-white hover:!text-white font-bold text-xs uppercase tracking-widest py-3 px-6 rounded shadow-lg shadow-[#cd1d46]/20 w-full block transition-transform active:scale-95 cursor-pointer">
                        Подписаться
                    </a>
                </div>
            </div>
            ...
            <button type="button" data-x-bind="restoreBtn"
                class="w-12 h-12 bg-[#cd1d46] hover:bg-[#b71833] text-white shadow-lg shadow-[#cd1d46]/30 flex items-center justify-center transition-transform hover:scale-105 active:scale-95 border border-[#cd1d46]"
    ...
    <div data-x-data="{
        ...
        <div class="flex flex-row md:flex-col gap-4">
            ...
            @if(isset($contacts['whatsapp']) && $contacts['whatsapp'])
                <a href="https://wa.me/{{ $contacts['whatsapp'] }}" target="_blank"
                   class="w-12 h-12 bg-[#25D366] hover:bg-[#128C7E] text-white shadow-lg shadow-[#25D366]/30 flex items-center justify-center transition-transform hover:scale-105 active:scale-95"
                   aria-label="WhatsApp">
            ...
            @if(isset($contacts['telegram']) && $contacts['telegram'])
                <a href="https://t.me/{{ $contacts['telegram'] }}" target="_blank"
                   class="w-12 h-12 bg-[#0088cc] hover:bg-[#006699] text-white shadow-lg shadow-[#0088cc]/30 flex items-center justify-center transition-transform hover:scale-105 active:scale-95"
                   aria-label="Telegram">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button type="button" data-x-bind="scrollBtn"
            class="w-12 h-12 bg-[#050505] text-[#cd1d46] rounded border border-gray-800 shadow-xl flex items-center justify-center hover:bg-[#cd1d46] hover:text-white hover:border-[#cd1d46] transition-all active:scale-95 group"
            aria-label="Наверх">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const floatingContactLinks = document.querySelectorAll('a[href*="wa.me"], a[href*="t.me"]');
