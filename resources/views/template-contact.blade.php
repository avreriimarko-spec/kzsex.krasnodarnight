...
@section('content')
    ...
    <div class="bg-black text-white pt-16 pb-24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-5 space-y-6">
                ...
                <div class="bg-black  p-8 border border-[#cd1d46]">
                    <h2 class="text-2xl font-bold text-white mb-6 uppercase">Свяжитесь с нами</h2>

                    <div class="space-y-4">
                        {{-- Telegram --}}
                        @if ($contacts['tg'])
                            <a href="https://t.me/{{ str_replace('@', '', $contacts['tg']) }}" target="_blank"
                                class="group flex items-center gap-4 p-4  bg-black border border-[#cd1d46] hover:bg-[#cd1d46] transition-all duration-300 transform hover:scale-105">
                                
                                {{-- Иконка: стиль скопирован из услуг (красный круг, белая иконка -> при ховере белый круг, красная иконка) --}}
                                <div class="w-12 h-12 flex-shrink-0  bg-[#cd1d46] flex items-center justify-center group-hover:bg-white transition-colors">
                                    <svg class="w-6 h-6 text-white group-hover:text-[#cd1d46]" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="overflow-hidden">
                                    ...
                                    <div class="font-bold text-lg text-white group-hover:text-white truncate">{{ $contacts['tg'] }}</div>
                                </div>
                            </a>
                        @endif
                        ...
                        @if ($contacts['wa'])
                            <a href="https://wa.me/{{ $contacts['wa'] }}" target="_blank"
                                ...
                                <div class="overflow-hidden">
                                    ...
                                    <div class="font-bold text-lg text-white group-hover:text-white truncate">{{ $contacts['wa'] }}</div>
                                </div>
                            </a>
                        @endif
                        ...
                        @if ($contacts['email'])
                            <a href="mailto:{{ $contacts['email'] }}"
                                ...
                                <div class="w-12 h-12 flex-shrink-0  bg-[#cd1d46] flex items-center justify-center group-hover:bg-white transition-colors">
                                    <svg class="w-6 h-6 text-white group-hover:text-[#cd1d46]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="overflow-hidden">
                                    ...
                                    <div class="font-bold text-lg text-white group-hover:text-white truncate">{{ $contacts['email'] }}</div>
                                </div>
                            </a>
                        @endif
                    </div>
                    ...
                    @if ($contacts['hours'])
                        <div class="mt-8 pt-6 border-t border-gray-800">
                            ...
                            <div class="font-bold text-white">{{ $contacts['hours'] }}</div>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="lg:col-span-7">
                ...
                <div class="bg-black  p-8 border border-[#cd1d46] h-full">
                    <h2 class="text-2xl font-bold text-white mb-2 uppercase">Напишите нам</h2>
