...
@section('content')
    ...
    <div class="bg-gray-900 text-black pt-20 pb-24 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 text-center max-w-4xl relative z-10">
            <span
                class="inline-block py-1 px-3 rounded bg-red-600 text-black text-xs font-bold capitalize mb-4 tracking-widest">
                Вакансии
            </span>
            <h1 class="text-4xl md:text-6xl font-bold capitalize mb-6 tracking-tight leading-tight">
            ...
            <div class="mt-8">
                <a href="#apply-form"
                    class="inline-block bg-white text-gray-900 hover:bg-gray-100 font-bold capitalize py-4 px-10  shadow-lg transition transform hover:-translate-y-1">
                    Заполнить анкету
                </a>
            </div>
        </div>
                ...
                <div class="bg-gray-900 p-8 md:p-12 shadow-2xl relative overflow-hidden">
                    ...
                    <div class="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="bg-white/10 backdrop-blur-sm p-8 border border-white/10 text-center">
                            ...
                            <div class="text-black font-bold capitalize mb-6">Конфиденциальность</div>
                            <div class="text-4xl font-bold text-red-500 mb-2">24/7</div>
                            <div class="text-black font-bold capitalize">Поддержка</div>
                        </div>
                    </div>
                </div>
            </div>
