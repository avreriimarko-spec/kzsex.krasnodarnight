...
add_action('acf/init', function () {
    ...
    acf_add_local_field_group([
        'key' => 'group_page_seo_extended',
        'title' => 'SEO и Контент (Расширенные)',
        'fields' => [
            // Вкладка: Мета-теги
            [
                'key' => 'field_tab_seo_meta',
                'label' => 'Meta Tags',
                'type' => 'tab',
            ],
            [
            ...
            [
                ...
                'label' => 'Текст под H1 (Intro)',
                'name' => 'intro_text',
                'type' => 'wysiwyg',
                'media_upload' => false,
                'tabs' => 'visual',
                'toolbar' => 'basic',
                'instructions' => 'Короткий абзац сразу под заголовком.',
            ],
            [
                'key' => 'field_main_seo_text',
        ...
        'position' => 'acf_after_title', // Сразу после заголовка
    ]);
});
